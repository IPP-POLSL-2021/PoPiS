...
if __name__ == "__main__":
    ...
    for i in IDs:
        ...
        print(get_name(10, i, response), get_status(10, i, response), get_reason(10, i, response), get_district(10, i, 'district_num',
              response), get_district(10, i, 1, response), get_district(10, i, 'województwo', response), get_club(10, i, response))
