...
# Przyjmuje numer kadencji i interpelacji a zwraca odpowiedź w formie json
def get_interpelation(term, num):
    response = requests.get(
        f'https://api.sejm.gov.pl/sejm/term{term}/interpellations/{num}')
    return response
...
# Przyjmuje odpowiedź jsonową z get_interpelation i zwraca listę linków do pobrania odpowiedzi w formie pdf
